...
// Answer Starts Here
  ...
  // 'Date'
  // Description: The app is a calander so it must track the dates.
  // Every 'date' has
  // - a year
  // - a month
  // - a day
  ...
  // 'Event'
  // Description: The app is a calander so it must display the events.
  // Every 'event' has
  // - a location
  // - a type
  // - a name
  ...
  // Every 'event' can
  // - be created
  // - get deleted or canceled
  // - be modified

  // 'Location'
  // Description: The app is a calander so it must display the location.
  // Every 'location' has
  // - a street
  // - a city
  // - a link 
