...
function diceRoll(){
    ...
    var dice1Class = "dice-" +random1;
    var dice2Class = "dice-" +random2;
    document.getElementById("first-die").className = dice1Class;
    document.getElementById("second-die").className = dice2Class;
